...
def construct_htg_data(glist, idx, time_window):
...
def load_data(glist, time_window):
    ...
    for i in range(len(glist)):
         if i >= time_window:
#        if i >= time_window_feature and i <= len(glist) - time_window_target:
            G_feat, G_label = construct_htg_data(glist, i, time_window)
